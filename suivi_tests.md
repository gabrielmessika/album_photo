...
| Correctif ergonomie et rendu texte à tester | `À FIGER` — panneau Texte, canevas dégagé, fond réel, palette colorée, aperçu à l’échelle et opacité immédiate ; `IPAD-L2-022` à exécuter |
