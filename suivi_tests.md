...
| Candidat ergonomique Lot 2 à tester | `331b5c3f785db7b0901afe0ced8fa67f98a4bb24` — Cadre décoratif fusionne formes et motifs en une sélection exclusive ; barre de texte bureautique au-dessus de la saisie et Annuler/Valider à droite ; 162 tests WSL, parse AppModule, 55 contrats et 16 empreintes réussis ; `IPAD-L2-082…083` à exécuter |
...
rejeté mais sont désormais ⚫ `NON APPLICABLE`, car remplacées un pour un par
`056…070` sur le correctif. Les
...
Le second correctif est figé au commit exact
`855ae271dcec348ddf5dc4e04ba40fa2f47ab0cb`. Les régressions
...
Le candidat ergonomique suivant est figé dans
`331b5c3f785db7b0901afe0ced8fa67f98a4bb24`. `IPAD-L2-082…083` portent les
deux nouvelles régressions iPad et `APPLE-L2-026…029` remplacent ses quatre
qualifications Apple, sans modifier les verdicts historiques.
...
| `IPAD-L2-040` | Boutons texte compacts et justification de page | `3:TBX-009` à `3:TBX-016`, `3:TBX-023` à `3:TBX-027`, `3:CAN-008`, `3:ACC-002`, `3:ACC-004` | ⚫ `NON APPLICABLE` — archive ; remplacé par `056` |
| `IPAD-L2-041` | Sessions de frappe, Annuler et historique à 750 ms | `3:TBX-002` à `3:TBX-005`, `3:TBX-022`, `3:TBX-025`, `3:UND-001`, `3:UND-008`, `3:SAV-001` | ⚫ `NON APPLICABLE` — archive ; remplacé par `057` |
| `IPAD-L2-042` | Limite et collage riche filtré | `3:TBX-006` à `3:TBX-008`, `3:TBX-010`, `3:TBX-017`, `3:TBX-023`, `3:CLP-005`, `3:ACC-002` | ⚫ `NON APPLICABLE` — archive ; remplacé par `058` |
| `IPAD-L2-043` | Débordement et blocage de la prévisualisation | `3:TBX-018` à `3:TBX-021`, `3:TBX-024`, `3:CAN-008`, `3:ACC-002`, `3:ACC-006` | ⚫ `NON APPLICABLE` — archive ; remplacé par `059` |
| `IPAD-L2-044` | Catalogue, catégories, recherche et récents des stickers | `3:STK-001` à `3:STK-003`, `3:STK-006`, `3:STK-009` à `3:STK-012`, `3:CAT-001`, `3:CAT-009` | ⚫ `NON APPLICABLE` — archive ; remplacé par `060` |
| `IPAD-L2-045` | Ajout, dépôt et géométrie des stickers | `3:STK-004`, `3:STK-005`, `3:STK-008`, `3:STK-015`, `3:STK-023`, `3:STK-024`, `3:ELM-001` à `3:ELM-004` | ⚫ `NON APPLICABLE` — archive ; remplacé par `061` |
| `IPAD-L2-046` | Remplacement et commandes d’un sticker | `3:STK-007`, `3:STK-014` à `3:STK-016`, `3:STK-022`, `3:ELM-008`, `3:UND-001` | ⚫ `NON APPLICABLE` — archive ; remplacé par `062` |
| `IPAD-L2-047` | Rendu, profondeur et persistance des stickers | `3:STK-009`, `3:STK-024`, `3:CAN-008`, `3:SAV-001`, `3:ACC-006` | ⚫ `NON APPLICABLE` — archive ; remplacé par `063` |
| `IPAD-L2-048` | Six formes et conservation du cadrage photo | `3:SHR-001` à `3:SHR-003`, `3:SHR-006`, `3:SHR-010`, `3:SHR-012`, `3:CRP-001`, `3:CRP-007` | ⚫ `NON APPLICABLE` — archive ; remplacé par `064` |
| `IPAD-L2-049` | Contours et six cadres décoratifs | `3:SHR-004`, `3:SHR-005`, `3:SHR-009`, `3:SHR-011`, `3:SHR-013`, `3:SHR-014`, `3:CAN-008` | ⚫ `NON APPLICABLE` — archive ; remplacé par `065` |
| `IPAD-L2-050` | Portées Sélection, Page et Album | `3:SHR-007`, `3:SHR-008`, `3:UND-001`, `3:SAV-001`, `3:ACC-002` | ⚫ `NON APPLICABLE` — archive ; remplacé par `066` |
| `IPAD-L2-051` | Copier et coller photo, texte et sticker | `3:CLP-001`, `3:CLP-003`, `3:CLP-004`, `3:ELM-009`, `3:FRM-007`, `3:SAV-001` | ⚫ `NON APPLICABLE` — archive ; remplacé par `067` |
| `IPAD-L2-052` | Couper, annuler et invalider le presse-papiers | `3:CLP-002`, `3:CLP-004`, `3:CLP-006`, `3:UND-001`, `3:UND-002`, `3:SAV-001` | ⚫ `NON APPLICABLE` — archive ; remplacé par `068` |
| `IPAD-L2-053` | Aide et accessibilité du périmètre Lot 2 | `3:EDT-019`, `3:STK-022`, `3:ACC-001` à `3:ACC-008`, `3:ACC-020`, `3:ACC-021` | ⚫ `NON APPLICABLE` — archive ; remplacé par `069` |
| `IPAD-L2-054` | Fluidité à vingt stickers et avertissement au-delà | `3:STK-021`, `3:PERF-005`, `3:PERF-015`, `3:PERF-017`, `3:ACC-002` | ⚫ `NON APPLICABLE` — archive ; remplacé par `070` |
...
| `IPAD-L2-082` | Cadre décoratif exclusif, portées et historique | `3:SHR-001` à `3:SHR-003`, `3:SHR-006` à `3:SHR-010`, `3:SAV-001`, `3:UND-001`, `3:ACC-002`, `3:ACC-004` | ⚪ `NON TESTÉ` |
| `IPAD-L2-083` | Fenêtre texte bureautique et actions à droite | `3:TBX-004`, `3:TBX-005`, `3:TBX-009` à `3:TBX-016`, `3:TBX-022`, `3:TBX-026` à `3:TBX-029`, `3:UND-001`, `3:ACC-002`, `3:ACC-004`, `3:ACC-021` | ⚪ `NON TESTÉ` |
...
> Ces quinze fiches sont ⚫ `NON APPLICABLE` : les procédures actives sont
> leurs remplacements `056…070`. Tout retour saisi
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-056`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `056`.
- Environnement : non applicable ; voir `IPAD-L2-056`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-057`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `057`.
- Environnement : non applicable ; voir `IPAD-L2-057`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-058`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `058`.
- Environnement : non applicable ; voir `IPAD-L2-058`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-059`. La commande Exporter n’est pas publique dans ce candidat et
  sera testée avec un nouvel identifiant au Lot 3.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `059`.
- Environnement : non applicable ; voir `IPAD-L2-059`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-060`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `060`.
- Environnement : non applicable ; voir `IPAD-L2-060`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-061`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `061`.
- Environnement : non applicable ; voir `IPAD-L2-061`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-062`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `062`.
- Environnement : non applicable ; voir `IPAD-L2-062`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-063`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `063`.
- Environnement : non applicable ; voir `IPAD-L2-063`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-064`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `064`.
- Environnement : non applicable ; voir `IPAD-L2-064`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-065`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `065`.
- Environnement : non applicable ; voir `IPAD-L2-065`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-066`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `066`.
- Environnement : non applicable ; voir `IPAD-L2-066`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-067`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `067`.
- Environnement : non applicable ; voir `IPAD-L2-067`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-068`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `068`.
- Environnement : non applicable ; voir `IPAD-L2-068`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-069`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `069`.
- Environnement : non applicable ; voir `IPAD-L2-069`.
...
- Résultat : ⚫ `NON APPLICABLE` — fiche obsolète, remplacée par
  `IPAD-L2-070`.
- Preuve : aucune exécution sur ce candidat ; procédure reprise sous `070`.
- Environnement : non applicable ; voir `IPAD-L2-070`.
...
## Secondes régressions collage, cadres et panneaux

Les trois fiches suivantes visent exactement
`855ae271dcec348ddf5dc4e04ba40fa2f47ab0cb`. Récupérer ce commit sans édition
locale et réutiliser `Lot2-Final`. Elles peuvent être exécutées séparément si
leurs préconditions sont reconstruites. Arrêter une fiche au premier défaut et
répondre avec son identifiant ainsi que le numéro d’étape.

### `IPAD-L2-075` — Seconde régression du collage riche

- Candidat : `855ae271dcec348ddf5dc4e04ba40fa2f47ab0cb`.
- Spécification : 3.0 incluse dans le candidat exact.
- Préconditions : reprendre dans Notes l’extrait inférieur à 1 000 caractères
  de `IPAD-L2-071`, avec au moins un mot gras, un mot italique, un lien, une
  liste et une petite image ; conserver aussi l’extrait de plus de 1 000
  caractères. Une zone de texte existante est disponible dans `Lot2-Final`.
- Exigences : `3:ENV-001` à `3:ENV-005`, `3:TBX-004`, `3:TBX-006` à
  `3:TBX-008`, `3:TBX-017`, `3:TBX-023`, `3:CLP-005`, `3:DONE-005`.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Compiler et lancer le candidat exact, puis ouvrir la zone de texte existante. | La compilation et l’ouverture réussissent sans diagnostic dans `AlbumTextEditorView` ; le texte initial est lisible. |
| 2 | Remplacer le contenu par « Avant collage », mettre « Avant » en gras et « collage » en italique, puis placer le curseur à la fin. | Les deux styles sont visibles et constituent un état antérieur reconnaissable sous la limite. |
| 3 | Coller l’extrait Notes inférieur à 1 000 caractères. | Les mots gras et italique de l’extrait restent distinctement formatés ; texte et retours à la ligne sont conservés ; image, pièce jointe, structure de liste, lien actif et métadonnées sont retirés sans perdre le libellé du lien. |
| 4 | Presser Terminer, rouvrir la zone et comparer le passage collé. | Le texte filtré et ses styles gras/italique persistent exactement ; aucun contenu interdit ne réapparaît. |
...
- Candidat : `855ae271dcec348ddf5dc4e04ba40fa2f47ab0cb`.
- Spécification : 3.0 incluse dans le candidat exact.
- Préconditions : page contenant deux cadres photo remplis, l’un large et
  l’autre haut, avec des photos très contrastées par rapport au fond ; cadrages
  relevés avant test et panneau Cadres et formes disponible.
- Exigences : `3:SHR-004`, `3:SHR-005`, `3:SHR-009`, `3:SHR-011`,
  `3:SHR-013`, `3:SHR-014`, `3:CAN-008`, `3:ACC-002`, `3:ACC-004`.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Appliquer successivement Bord blanc puis Bord noir aux deux rapports et examiner les quatre côtés en zoomant. | Le décor atteint les limites prévues et seule son ouverture centrale montre la photo ; aucune frange de photo n’est visible dans les transparences extérieures, même avec fort contraste. |
| 2 | Parcourir Ruban kraft, Tampon voyage, Feuillage et Photo instantanée sur les deux cadres. | Chaque ouverture suit son alpha propre, y compris l’asymétrie de Photo instantanée ; les zones transparentes extérieures révèlent le fond de page et jamais la photo. |
| 3 | Choisir Aucun dans Contour et examiner les couleurs visuellement, au toucher puis avec VoiceOver. | Aucun est indiqué comme actif ; toutes les couleurs sont atténuées, inactives et annoncées indisponibles jusqu’au choix d’une épaisseur. |
| 4 | Activer tour à tour Fin, Moyen et Épais, puis choisir deux couleurs contrastées. | Exactement trois épaisseurs non nulles sont proposées sans pourcentage ; elles produisent trois largeurs croissantes et la couleur ne devient active qu’après leur sélection. |
...
- Candidat : `855ae271dcec348ddf5dc4e04ba40fa2f47ab0cb`.
- Spécification : 3.0 incluse dans le candidat exact.
- Préconditions : page contenant une photo, une zone de texte et un sticker à
  des positions qui pourraient passer sous les panneaux après zoom/déplacement ;
  relever la sélection initiale et rester hors mode cadrage.
- Exigences : `3:EDT-001`, `3:EDT-002`, `3:EDT-012`, `3:ZOM-001`,
  `3:ZOM-004`, `3:ZOM-005`, `3:ACC-002`, `3:ACC-003`.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Régler le canevas à 200 %, déplacer la page vers la gauche pour amener ses objets vers le rail, puis toucher successivement Photos, Texte, Stickers, Mise en page, Fonds et Cadres et formes. | Chaque pression active uniquement le menu demandé ; aucun objet sous-jacent n’est sélectionné, déplacé ou modifié et la page ne se dessine pas par-dessus le rail. |
| 2 | Laisser le panneau droit ouvert, déplacer la page vers la droite puis utiliser plusieurs commandes, menus et champs de ce panneau. | Chaque commande du panneau reçoit la pression ; la page et ses objets situés géométriquement dessous ne l’interceptent jamais. |
| 3 | Refaire les deux contrôles à 300 % puis 400 %. | La priorité tactile et les limites visuelles restent identiques aux trois forts niveaux de zoom, sans zone morte sur les panneaux. |
| 4 | Tourner l’iPad en paysage et répéter l’ouverture des six menus à 200 %. | Rail, panneau, page et sélection restent cohérents ; aucun objet n’est sélectionné à travers l’interface dans la seconde orientation. |
...
## Troisièmes régressions collage et cadres

Les deux fiches suivantes visent exactement
`92df51ddaab5798a3d4a5aac2c7ede2a3b9bfa44`. Récupérer ce commit sans édition
locale et réutiliser `Lot2-Final`. Elles sont indépendantes ; `IPAD-L2-077`
n’est pas à rejouer, car ce candidat ne modifie pas l’arbitrage tactile des
panneaux.

### `IPAD-L2-078` — Troisième régression du collage riche Notes

- Candidat : `92df51ddaab5798a3d4a5aac2c7ede2a3b9bfa44`.
- Spécification : 3.0 incluse dans le candidat exact.
- Préconditions : reprendre exactement l’extrait Notes inférieur à 1 000
  caractères de `IPAD-L2-075`, avec un mot gras, un mot italique, un lien, une
  liste et une petite image ; conserver aussi l’extrait de plus de 1 000
  caractères. Une zone de texte reconnaissable existe dans `Lot2-Final`.
- Exigences : `3:ENV-001` à `3:ENV-005`, `3:TBX-004`, `3:TBX-006` à
  `3:TBX-008`, `3:TBX-017`, `3:TBX-023`, `3:CLP-005`, `3:DONE-005`.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Compiler et lancer le candidat exact, puis ouvrir la zone de texte existante. | La compilation et l’ouverture réussissent sans diagnostic dans `AlbumTextEditorView` ; le contenu initial est lisible. |
| 2 | Remplacer le contenu par « Avant collage », mettre « Avant » en gras et « collage » en italique, puis placer le curseur à la fin. | Les styles locaux sont visibles et constituent un état antérieur reconnaissable sous la limite. |
| 3 | Dans Notes, recopier l’extrait riche puis le coller immédiatement dans la zone. | Les mots gras et italique de l’extrait restent distinctement formatés ; texte et retours à la ligne sont conservés ; image, pièce jointe, structure de liste, lien actif et métadonnées disparaissent sans perdre le libellé du lien. |
| 4 | Presser Terminer, rouvrir la zone et comparer le passage collé. | Le texte filtré et ses styles gras/italique persistent exactement ; aucun contenu interdit ne réapparaît. |
...
### `IPAD-L2-079` — Grille de contour et Photo instantanée sans recadrage

- Candidat : `92df51ddaab5798a3d4a5aac2c7ede2a3b9bfa44`.
- Spécification : 3.0 incluse dans le candidat exact.
- Préconditions : reprendre la page et la photo de `IMG_4218.jpeg`, ou recréer
  quatre occurrences strictement identiques : originale, Photo instantanée avec
  contour vert Épais, Photo instantanée seule et contour vert Épais seul. Le
  cadrage original ne touche pas les quatre limites du cadre.
- Exigences : `3:SHR-004`, `3:SHR-005`, `3:SHR-009`, `3:SHR-011`,
  `3:SHR-013`, `3:SHR-014`, `3:CRP-007`, `3:CAN-008`, `3:ACC-002`,
  `3:ACC-004`.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Compiler, lancer, ouvrir la page de comparaison puis relever le cadrage, le point focal et l’orientation des quatre occurrences. | Le candidat compile ; les quatre photos commencent avec le même contenu visible et des placements comparables. |
| 2 | Ouvrir Cadres et formes en portrait puis en paysage et parcourir Aucun, Fin, Moyen et Épais. | Les quatre choix occupent une grille 2 × 2 ; chaque libellé reste sur une seule ligne, lisible et sélectionnable, avec un état actif visible et accessible. |
| 3 | Appliquer Photo instantanée sans contour et comparer la photo à l’originale. | Le décor entoure la photo et peut dépasser son cadre logique ; la partie visible, le zoom, le point focal, l’orientation et la taille du masque restent strictement inchangés, sans réduction ni troncature. |
| 4 | Ajouter le contour vert Épais à Photo instantanée et examiner les quatre côtés en zoomant. | Le contour reste entièrement à l’intérieur du masque et visible sur les quatre côtés, y compris en bas ; le décor reste au-dessus et autour sans recouvrir tout le contour. |
...
### `IPAD-L2-082` — Cadre décoratif exclusif, portées et historique

- Candidat : `331b5c3f785db7b0901afe0ced8fa67f98a4bb24`.
- Spécification : 3.0 incluse dans le candidat exact ; décision utilisateur du
  24 août 2026 enregistrée sous `SHR-001`, `SHR-003` et `SHR-007`.
- Préconditions : reprendre l’album de cadres validé sous `IPAD-L2-081`, avec
  au moins deux cadres photo sur la page active et un troisième sur une autre
  page. Relever le cadrage et appliquer un contour Épais contrasté au premier.
- Exigences : `3:SHR-001` à `3:SHR-003`, `3:SHR-006` à `3:SHR-010`,
  `3:SAV-001`, `3:UND-001`, `3:ACC-002`, `3:ACC-004`.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Compiler et lancer le candidat exact, sélectionner le premier cadre puis ouvrir Cadres et formes. | La compilation réussit ; le panneau montre Portée, une seule section Cadre décoratif avec Aucun puis les sous-sections Formes et Bordures et motifs, ainsi qu’une section Contour indépendante ; aucune section Forme séparée n’apparaît. |
| 2 | En portée Sélection, choisir Cercle puis observer les coches et le cadre. | Cercle est le seul choix décoratif coché, la photo est masquée en cercle et le contour reste présent sans motif superposé ni changement du cadrage relevé. |
| 3 | Choisir Ruban kraft sur le même cadre. | Ruban kraft remplace Cercle au lieu de s’y ajouter : le masque redevient rectangulaire, une seule coche décorative reste visible et le contour ainsi que le cadrage sont inchangés. |
| 4 | Choisir Aucun. | Forme et motif disparaissent ensemble, Rectangle/Aucun devient l’unique état décoratif actif et le contour indépendant reste inchangé. |
| 5 | En portée Page choisir Étoile, puis en portée Album choisir Feuillage. | Chaque commande annonce le bon nombre de cadres ; Étoile s’applique seulement à la page, puis Feuillage la remplace par un masque rectangulaire sur toutes les photos de l’album en une seule action. |
| 6 | Utiliser Annuler puis Rétablir, fermer et rouvrir l’album, comparer éditeur/miniature/Prévisualiser et parcourir les choix avec VoiceOver. | Un seul Annuler restaure exactement les décors précédents de toute la portée et Rétablir les réapplique ; l’état exclusif persiste et concorde dans les sorties ; noms, états et cibles sont annoncés sans ambiguïté. |

- Résultat : ⚪ `NON TESTÉ`.
- Preuve : à renseigner — résultat de chaque étape, nombres annoncés, captures
  Cercle/Ruban kraft/Aucun et observations Annuler/Rétablir/VoiceOver.
- Environnement : iPad 8e génération, iPadOS 26.5.2, Swift Playgrounds 4.7 ;
  relever toute différence et le mode de transfert du candidat.

### `IPAD-L2-083` — Fenêtre texte bureautique et actions à droite

- Candidat : `331b5c3f785db7b0901afe0ced8fa67f98a4bb24`.
- Spécification : 3.0 incluse dans le candidat exact ; ergonomie demandée à
  partir de la référence `photoweb2.png`, sans copie d’asset Photoweb.
- Préconditions : reprendre une zone contenant plusieurs mots et deux
  paragraphes reconnaissables ; relever son contenu, ses styles et son opacité.
  Préparer portrait, paysage, clavier logiciel et VoiceOver.
- Exigences : `3:TBX-004`, `3:TBX-005`, `3:TBX-009` à `3:TBX-016`,
  `3:TBX-022`, `3:TBX-026` à `3:TBX-029`, `3:UND-001`, `3:ACC-002`,
  `3:ACC-004`, `3:ACC-021`.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Compiler, lancer, ouvrir Modifier le texte en portrait et observer la composition sans faire défiler. | La barre de formatage est immédiatement au-dessus du texte ; une colonne distincte à droite garde Annuler avec une croix et Valider avec une coche visibles simultanément. |
| 2 | Parcourir la barre de gauche à droite. | La police courante et la taille en points sont lisibles ; Gras, Italique, Couleur, Alignement, Interligne et Opacité utilisent des icônes bureautiques reconnaissables dans cet ordre, sans titres Sélection, Paragraphe ou Zone. |
| 3 | Sélectionner un mot, appliquer Gras et Italique, puis centrer le second paragraphe et changer l’opacité. | Les changements visent respectivement la sélection, le paragraphe et la zone ; les états actifs restent visibles autrement que par la couleur et le clavier ne masque pas durablement la sélection. |
| 4 | Presser Annuler dans la colonne droite. | La fenêtre se ferme et restaure exactement le contenu, les styles et l’opacité relevés à l’ouverture, sans créer de commande Annuler dans l’album. |
| 5 | Rouvrir, modifier un mot et sa taille, puis presser Valider dans la colonne droite et utiliser Annuler/Rétablir dans l’éditeur d’album. | Valider persiste le texte et le format comme une action cohérente ; Annuler/Rétablir restaure successivement les états sans fermer ni perdre la zone. |
| 6 | Refaire les contrôles 1 à 3 en paysage, avec le clavier visible puis VoiceOver et une grande taille de texte système. | Barre, surface et deux actions restent accessibles sans chevauchement ni défilement vertical des actions ; ordre de focus, libellés, valeurs actives et cibles tactiles restent compréhensibles. |

- Résultat : ⚪ `NON TESTÉ`.
- Preuve : à renseigner — captures portrait/paysage, résultat de chaque étape,
  styles avant/après, comportement du clavier et annonces VoiceOver.
- Environnement : reprendre celui de `IPAD-L2-082`, sans différence déclarée.
...
`APPLE-L2-022…025` restent attachés au candidat exact `f483fa9…`.
`APPLE-L2-026…029` les remplacent pour `331b5c3…` et restent tous ⚪
`NON TESTÉ` jusqu’à une campagne séparée visant ce candidat explicitement
enregistré.
...
| `APPLE-L2-014` | Interface finale, contours et panneaux en largeur compacte | `3:EDT-001` à `3:EDT-004`, `3:EDT-008`, `3:EDT-012`, `3:EDT-014`, `3:EDT-016`, `3:EDT-020`, `3:EDT-021`, `3:TBX-005`, `3:TBX-027`, `3:SHR-004`, `3:ZOM-005`, `3:ACC-002`, `3:ACC-003`, `3:ACC-021` | ⚪ `NON TESTÉ` | Remplace `APPLE-L2-010` sur `855ae27…` ; iPhone réel ou Xcode compact requis |
| `APPLE-L2-015` | Debug/Release et tests Apple du second correctif | `3:ENV-006` à `3:ENV-009`, `3:TST-014` à `3:TST-016`, `3:DONE-005` | ⚪ `NON TESTÉ` | Remplace `APPLE-L2-011` ; macOS, Xcode et SDK iOS approuvés requis |
| `APPLE-L2-016` | Instruments et enveloppe maximale du second correctif | `3:STK-021`, `3:PERF-001` à `3:PERF-009`, `3:PERF-015` à `3:PERF-017` | ⚪ `NON TESTÉ` | Remplace `APPLE-L2-012` ; Instruments et jeu synthétique de 100 pages requis |
| `APPLE-L2-017` | Build TestFlight distincte du second correctif | `3:TST-003`, `3:TST-005`, `3:TST-015`, `3:DONE-001` à `3:DONE-005` | ⚪ `NON TESTÉ` | Remplace `APPLE-L2-013` ; build distincte de Swift Playgrounds |
| `APPLE-L2-018` | Interface résiduelle et cadres en largeur compacte | `3:EDT-001` à `3:EDT-004`, `3:EDT-008`, `3:EDT-012`, `3:EDT-014`, `3:EDT-016`, `3:EDT-020`, `3:EDT-021`, `3:TBX-005`, `3:TBX-027`, `3:SHR-004`, `3:SHR-013`, `3:ZOM-005`, `3:ACC-002`, `3:ACC-003`, `3:ACC-021` | ⚪ `NON TESTÉ` | Remplace `APPLE-L2-014` sur `92df51d…` ; iPhone réel ou Xcode compact requis |
...
| `APPLE-L2-026` | Cadre exclusif et nouvelle fenêtre texte en largeur compacte | `3:EDT-001` à `3:EDT-004`, `3:EDT-008`, `3:EDT-012`, `3:EDT-014`, `3:EDT-016`, `3:EDT-020`, `3:EDT-021`, `3:TBX-005`, `3:TBX-026` à `3:TBX-029`, `3:SHR-001`, `3:SHR-003`, `3:SHR-007`, `3:ACC-002`, `3:ACC-003`, `3:ACC-021` | ⚪ `NON TESTÉ` | Remplace `APPLE-L2-022` sur `331b5c3…` ; iPhone réel ou Xcode compact requis |
| `APPLE-L2-027` | Debug/Release et tests Apple du candidat ergonomique | `3:ENV-006` à `3:ENV-009`, `3:TST-014` à `3:TST-016`, `3:DONE-005` | ⚪ `NON TESTÉ` | Remplace `APPLE-L2-023` ; macOS, Xcode et SDK iOS approuvés requis |
| `APPLE-L2-028` | Instruments et enveloppe maximale du candidat ergonomique | `3:STK-021`, `3:PERF-001` à `3:PERF-009`, `3:PERF-015` à `3:PERF-017` | ⚪ `NON TESTÉ` | Remplace `APPLE-L2-024` ; Instruments et jeu synthétique de 100 pages requis |
| `APPLE-L2-029` | Build TestFlight distincte du candidat ergonomique | `3:TST-003`, `3:TST-005`, `3:TST-015`, `3:DONE-001` à `3:DONE-005` | ⚪ `NON TESTÉ` | Remplace `APPLE-L2-025` ; build distincte de Swift Playgrounds |
...
### `APPLE-L2-014` — Interface finale, contours et panneaux en largeur compacte

- Candidat : `855ae271dcec348ddf5dc4e04ba40fa2f47ab0cb`.
- Spécification : 3.0 incluse dans ce commit.
- Type : test manuel sur iPhone réel ou simulateur Xcode produisant une largeur
  compacte réelle ; remplace `APPLE-L2-010` pour le candidat courant.
- Exigences : `3:EDT-001` à `3:EDT-004`, `3:EDT-008`, `3:EDT-012`,
  `3:EDT-014`, `3:EDT-016`, `3:EDT-020`, `3:EDT-021`, `3:TBX-005`,
  `3:TBX-027`, `3:SHR-004`, `3:ZOM-005`, `3:ACC-002`, `3:ACC-003`,
  `3:ACC-021`.
- Préconditions : album contenant photo, texte, petit sticker et cadre
  décoratif ; clavier, VoiceOver, zoom et presse-papiers disponibles.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Ouvrir l’éditeur en portrait compact et parcourir les six panneaux. | Barres, canevas et contenus de chaque panneau restent accessibles sans rognage ni superposition tactile. |
| 2 | Modifier un texte avec le clavier visible et ouvrir chaque menu de format. | Curseur, sélection, Terminer et valeurs restent accessibles ; le clavier ne masque pas durablement le contenu. |
| 3 | Choisir un cadre décoratif puis parcourir Aucun, Fin, Moyen, Épais et les couleurs. | Les quatre états d’épaisseur tiennent dans l’interface ; les couleurs sont inactives avec Aucun et actives sinon. |
| 4 | Zoomer autant que la largeur compacte l’autorise puis utiliser les panneaux alors que la page approche leurs limites. | Les panneaux reçoivent les pressions et aucun objet de page sous-jacent n’est sélectionné à travers eux. |
| 5 | Réduire un sticker au minimum et utiliser déplacement, rotation et deux poignées. | Le dessin n’occulte pas le sticker et toutes les cibles tactiles restent utilisables sans conflit. |
| 6 | Passer en paysage et parcourir barres, menus, panneau Cadres et formes et petite sélection avec VoiceOver. | Page et sélection persistent ; ordre de focus, libellés, états désactivés et cibles restent cohérents. |

- Résultat : ⚪ `NON TESTÉ`.
- Preuve : à renseigner — appareil/simulateur, dimensions, OS, Xcode,
  orientations, clavier, VoiceOver et captures de tout rognage/interception.
- Environnement : à renseigner.

### `APPLE-L2-015` — Debug, Release et tests Apple du second correctif
...
| 4 | En Debug puis Release, rejouer `IPAD-L2-075…077`. | Collage riche, ouvertures/contours et priorité tactile des panneaux sont conformes dans les deux configurations. |
| 5 | Sauvegarder, fermer et relancer après chaque configuration. | Le document persiste sans crash, perte, duplication ni divergence de rendu. |
...
### `APPLE-L2-016` — Instruments et enveloppe maximale du second correctif

- Candidat : `855ae271dcec348ddf5dc4e04ba40fa2f47ab0cb`.
- Spécification : 3.0 incluse dans ce commit.
- Type : campagne Instruments sur build Release et données synthétiques non
  personnelles ; remplace `APPLE-L2-012`.
- Exigences : `3:STK-021`, `3:PERF-001` à `3:PERF-009`, `3:PERF-015` à
  `3:PERF-017`.
- Préconditions : appareil documenté ; cent albums et un album de cent pages,
...
| 4 | Appliquer les six cadres décoratifs à plusieurs rapports et tailles puis revenir plusieurs fois sur les pages. | Chaque alpha est analysé une fois au besoin puis réutilisé ; aucun calcul lourd répété ni blocage durable du thread principal n’apparaît. |
| 5 | Revenir plusieurs fois à la Bibliothèque après modification de la couverture. | Cache et préchargement évitent les recompositions continues ; la miniature reste fidèle sans pic croissant. |
...
- Résultat : ⚪ `NON TESTÉ`.
- Preuve : à renseigner — trace Instruments, modèle, état thermique, tailles du
  jeu, temps, FPS, pic mémoire et observations des caches alpha/image.
- Environnement : à renseigner.

### `APPLE-L2-017` — Build TestFlight distincte du second correctif

- Candidat : `855ae271dcec348ddf5dc4e04ba40fa2f47ab0cb`.
- Spécification : 3.0 incluse dans ce commit.
- Type : build TestFlight issue de l’archive Release validée par
  `APPLE-L2-015`, séparée du package Swift Playgrounds ; remplace
  `APPLE-L2-013`.
- Exigences : `3:TST-003`, `3:TST-005`, `3:TST-015`, `3:DONE-001` à
  `3:DONE-005`.
- Préconditions : build/numéro exacts enregistrés ; installation propre puis
...
| 1 | Installer la build sur iPhone et iPad puis lancer la Bibliothèque. | Installation, lancement et lecture réussissent sans dépendre de Swift Playgrounds. |
| 2 | Créer ou ouvrir un album et parcourir photo, texte, sticker, forme, contour et cadre décoratif. | Toutes les fonctions publiques du Lot 2 sont présentes et correctement rendues. |
| 3 | Rejouer les contrôles fonctionnels de `IPAD-L2-075…077`. | Collage riche, ouvertures/contours et panneaux à fort zoom restent conformes dans la build distribuée. |
| 4 | Annuler/rétablir, sauvegarder, passer en arrière-plan, forcer la fermeture puis relancer hors ligne. | Données et ressources intégrées persistent ; aucun presse-papiers de session ne ressuscite. |
| 5 | Tester portrait, paysage, grande taille de texte et VoiceOver sur les deux familles d’appareil. | Aucun contrôle essentiel n’est inaccessible et les libellés/états restent compréhensibles. |
| 6 | Examiner journaux TestFlight et rapports de crash. | Aucun crash, blocage, corruption ni erreur répétée de catalogue n’est enregistré. |
...
### `APPLE-L2-018` — Interface résiduelle et cadres en largeur compacte

- Candidat : `92df51ddaab5798a3d4a5aac2c7ede2a3b9bfa44`.
- Spécification : 3.0 incluse dans ce commit.
- Type : test manuel sur iPhone réel ou simulateur Xcode produisant une largeur
  compacte réelle ; remplace `APPLE-L2-014` pour le candidat courant.
- Exigences : `3:EDT-001` à `3:EDT-004`, `3:EDT-008`, `3:EDT-012`,
  `3:EDT-014`, `3:EDT-016`, `3:EDT-020`, `3:EDT-021`, `3:TBX-005`,
  `3:TBX-027`, `3:SHR-004`, `3:SHR-013`, `3:ZOM-005`, `3:ACC-002`,
  `3:ACC-003`, `3:ACC-021`.
- Préconditions : album contenant photo, texte, petit sticker et Photo
  instantanée avec contour ; clavier, VoiceOver, zoom et presse-papiers
  disponibles.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Ouvrir l’éditeur en portrait compact et parcourir les six panneaux. | Barres, canevas et contenus restent accessibles sans rognage ni superposition tactile. |
| 2 | Modifier un texte avec le clavier visible puis coller un extrait Notes gras/italique. | Curseur, sélection, Terminer et formats restent accessibles ; le collage conserve les deux emphases sans contenu interdit. |
| 3 | Ouvrir Cadres et formes puis parcourir Aucun, Fin, Moyen, Épais et les couleurs. | La grille 2 × 2 tient dans la largeur ; chaque libellé reste sur une ligne et les couleurs sont désactivées avec Aucun. |
| 4 | Appliquer Photo instantanée avec puis sans contour sur une photo dont le cadrage ne remplit pas le masque. | Le décor entoure la photo sans la réduire ; le contour reste intérieur et visible sur quatre côtés, sans fuite de photo dans l’alpha extérieur. |
| 5 | Zoomer puis utiliser les panneaux alors que la page approche leurs limites. | Les panneaux reçoivent les pressions et aucun objet sous-jacent n’est sélectionné à travers eux. |
| 6 | Passer en paysage et parcourir barres, formats, cadres et petite sélection avec VoiceOver. | Page et sélection persistent ; ordre de focus, libellés, états désactivés et cibles restent cohérents. |
...
### `APPLE-L2-019` — Debug, Release et tests Apple du troisième correctif
...
| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Résoudre le package et compiler Debug pour iPhone et iPad. | Les deux destinations compilent sans erreur SwiftUI/UIKit, disponibilité de type RTF, ressource absente ni avertissement bloquant. |
| 2 | Exécuter tous les tests Core et Apple disponibles. | Tous réussissent ; nombre, durée, SDK et destinations sont enregistrés. |
| 3 | Compiler Release, créer l’archive puis lancer sa validation Xcode. | Archive et validation réussissent sans API privée, ressource dupliquée, défaut de signature ni manifeste invalide. |
| 4 | En Debug puis Release, rejouer `IPAD-L2-078…079` ainsi que le contrôle de panneaux de `077`. | Collage riche, grille, cadres/contours et priorité tactile sont conformes dans les deux configurations. |
...
### `APPLE-L2-020` — Instruments et enveloppe maximale du troisième correctif

- Candidat : `92df51ddaab5798a3d4a5aac2c7ede2a3b9bfa44`.
- Spécification : 3.0 incluse dans ce commit.
- Type : campagne Instruments sur build Release et données synthétiques non
  personnelles ; remplace `APPLE-L2-016`.
- Exigences : `3:STK-021`, `3:PERF-001` à `3:PERF-009`, `3:PERF-015` à
  `3:PERF-017`.
- Préconditions : appareil documenté ; cent albums et un album de cent pages,
  avec vingt photos, vingt textes et vingt stickers par page ; six décors
...
| 2 | Parcourir rapidement vingt pages en surveillant mémoire et allocations. | Le préchauffage reste borné et le pic mémoire demeure inférieur à 500 Mo sans croissance persistante. |
| 3 | Transformer photo, texte et petit sticker avec Core Animation et Time Profiler. | Les gestes visent 60 images/s sans décodage pleine résolution ni écriture durable par image. |
| 4 | Appliquer les six cadres à plusieurs rapports et tailles puis revenir plusieurs fois sur les pages. | L’alpha et les limites élargies sont calculés une fois au besoin puis réutilisés ; aucun calcul lourd répété ni blocage durable du thread principal n’apparaît. |
| 5 | Répéter des collages Notes riches courts puis revenir plusieurs fois à la Bibliothèque. | Le décodage ponctuel du presse-papiers ne crée ni fuite, ni croissance persistante, ni recomposition continue de la couverture. |
| 6 | Examiner fuites, CPU, énergie, blocages et avertissement au vingt-et-unième sticker. | Aucune fuite, suspension ni crash mémoire ; seul l’avertissement prévu apparaît. |

- Résultat : ⚪ `NON TESTÉ`.
- Preuve : à renseigner — trace Instruments, modèle, état thermique, tailles du
  jeu, temps, FPS, pic mémoire et observations des caches/presse-papiers.
- Environnement : à renseigner.

### `APPLE-L2-021` — Build TestFlight distincte du troisième correctif

- Candidat : `92df51ddaab5798a3d4a5aac2c7ede2a3b9bfa44`.
- Spécification : 3.0 incluse dans ce commit.
- Type : build TestFlight issue de l’archive Release validée par
  `APPLE-L2-019`, séparée du package Swift Playgrounds ; remplace
  `APPLE-L2-017`.
- Exigences : `3:TST-003`, `3:TST-005`, `3:TST-015`, `3:DONE-001` à
  `3:DONE-005`.
- Préconditions : build/numéro exacts enregistrés ; installation propre puis
...
| 1 | Installer la build sur iPhone et iPad puis lancer la Bibliothèque. | Installation, lancement et lecture réussissent sans dépendre de Swift Playgrounds. |
| 2 | Créer ou ouvrir un album et parcourir photo, texte, sticker, forme, contour et cadre décoratif. | Toutes les fonctions publiques du Lot 2 sont présentes et correctement rendues. |
| 3 | Rejouer `IPAD-L2-078…079` puis le contrôle tactile de `077`. | Collage riche, grille, cadrage/contours et panneaux à fort zoom restent conformes dans la build distribuée. |
| 4 | Annuler/rétablir, sauvegarder, passer en arrière-plan, forcer la fermeture puis relancer hors ligne. | Données et ressources intégrées persistent ; aucun presse-papiers de session ne ressuscite. |
| 5 | Tester portrait, paysage, grande taille de texte et VoiceOver sur les deux familles d’appareil. | Aucun contrôle essentiel n’est inaccessible et les libellés/états restent compréhensibles. |
...
### `APPLE-L2-026` — Cadre exclusif et fenêtre texte en largeur compacte

- Candidat : `331b5c3f785db7b0901afe0ced8fa67f98a4bb24`.
- Spécification : 3.0 incluse dans ce commit.
- Type : test manuel sur iPhone réel ou simulateur Xcode produisant une largeur
  compacte réelle ; remplace `APPLE-L2-022` pour le candidat courant.
- Exigences : `3:EDT-001` à `3:EDT-004`, `3:EDT-008`, `3:EDT-012`,
  `3:EDT-014`, `3:EDT-016`, `3:EDT-020`, `3:EDT-021`, `3:TBX-005`,
  `3:TBX-026` à `3:TBX-029`, `3:SHR-001`, `3:SHR-003`, `3:SHR-007`,
  `3:ACC-002`, `3:ACC-003`, `3:ACC-021`.
- Préconditions : album de `IPAD-L2-082…083`, clavier, VoiceOver et tailles de
  texte système disponibles ; largeur compacte confirmée dans l’environnement.

| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Ouvrir l’éditeur en portrait compact et parcourir les six panneaux avec une photo sélectionnée. | Rails, canevas, Cadre décoratif exclusif et Contour restent accessibles sans rognage, chevauchement ni interception par la page. |
| 2 | Ouvrir Modifier le texte avec le clavier visible. | Barre supérieure, surface de saisie et colonne droite restent utilisables ; Annuler et Valider sont tous deux visibles sans défilement vertical. |
| 3 | Sélectionner un mot puis appliquer successivement chaque format de la barre. | La sélection reste visible, les menus s’ouvrent dans l’écran et chaque état actif possède une indication visuelle et une valeur accessible. |
| 4 | Rejouer les étapes 2 à 5 de `IPAD-L2-082` sur plusieurs cadres. | Formes et motifs se remplacent sans cumul sur Sélection/Page/Album ; Aucun efface les deux et le contour reste indépendant. |
| 5 | Passer en paysage compact, zoomer le canevas puis rouvrir les panneaux et la fenêtre texte. | Les changements d’orientation conservent page, sélection et saisie ; aucun objet sous-jacent n’intercepte les actions. |
| 6 | Parcourir le tout avec VoiceOver et une grande taille de texte système. | Ordre de focus, libellés, valeurs, coches et cibles restent cohérents ; les deux actions de texte et Aucun restent atteignables. |

- Résultat : ⚪ `NON TESTÉ`.
- Preuve : à renseigner — appareil/simulateur, dimensions, OS, Xcode,
  orientations, captures, clavier, taille de texte et annonces VoiceOver.
- Environnement : à renseigner.

### `APPLE-L2-027` — Debug, Release et tests Apple du candidat ergonomique
...
| ID | Description | Résultat attendu |
|---:|---|---|
| 1 | Résoudre le package et compiler Debug pour iPhone et iPad. | Les deux destinations compilent sans erreur de type-check SwiftUI/UIKit, ressource absente ni avertissement bloquant. |
| 2 | Exécuter tous les tests Core et Apple disponibles. | Tous réussissent ; nombre, durée, SDK et destinations sont enregistrés. |
| 3 | Compiler Release, créer l’archive puis lancer sa validation Xcode. | Archive et validation réussissent sans API privée, ressource dupliquée, défaut de signature ni manifeste invalide. |
| 4 | En Debug puis Release, rejouer `IPAD-L2-082…083` et le contrôle tactile de `077`. | Exclusivité des décors, nouvelle fenêtre texte et priorité tactile sont conformes dans les deux configurations. |
| 5 | Sauvegarder, fermer et relancer après chaque configuration. | Décors, contours, textes et historique persistent sans crash, perte, cumul forme/motif ni divergence de rendu. |
...
### `APPLE-L2-028` — Instruments et enveloppe du candidat ergonomique

- Candidat : `331b5c3f785db7b0901afe0ced8fa67f98a4bb24`.
- Spécification : 3.0 incluse dans ce commit.
- Type : campagne Instruments sur build Release et données synthétiques non
  personnelles ; remplace `APPLE-L2-024`.
- Exigences : `3:STK-021`, `3:PERF-001` à `3:PERF-009`, `3:PERF-015` à
  `3:PERF-017`.
- Préconditions : appareil documenté ; cent albums et un album de cent pages,
  avec vingt photos, vingt textes et vingt stickers par page ; formes, motifs
  et fenêtre texte utilisés de manière répétée.
...
| 2 | Parcourir rapidement vingt pages en surveillant mémoire et allocations. | Le préchauffage reste borné et le pic mémoire demeure inférieur à 500 Mo sans croissance persistante. |
| 3 | Transformer photo, texte et petit sticker avec Core Animation et Time Profiler. | Les gestes visent 60 images/s sans décodage pleine résolution ni écriture durable par image. |
| 4 | Alterner formes, motifs et Aucun sur les trois portées puis annuler/rétablir. | Chaque portée crée une mutation atomique sans recomposition continue, blocage durable du thread principal ni croissance de l’historique au-delà d’une commande par action. |
| 5 | Ouvrir, formater, annuler et valider successivement vingt zones de texte. | Barre et colonne d’actions ne provoquent ni fuite, ni boucle de mise en page, ni croissance persistante après fermeture des feuilles. |
| 6 | Examiner fuites, CPU, énergie, blocages et avertissement au vingt-et-unième sticker. | Aucune fuite, suspension ni crash mémoire ; seul l’avertissement prévu apparaît. |

- Résultat : ⚪ `NON TESTÉ`.
- Preuve : à renseigner — trace Instruments, modèle, état thermique, tailles du
  jeu, temps, FPS, pic mémoire et observations des allocations.
- Environnement : à renseigner.

### `APPLE-L2-029` — Build TestFlight distincte du candidat ergonomique

- Candidat : `331b5c3f785db7b0901afe0ced8fa67f98a4bb24`.
- Spécification : 3.0 incluse dans ce commit.
- Type : build TestFlight issue de l’archive Release validée par
  `APPLE-L2-027`, séparée du package Swift Playgrounds ; remplace
  `APPLE-L2-025`.
- Exigences : `3:TST-003`, `3:TST-005`, `3:TST-015`, `3:DONE-001` à
  `3:DONE-005`.
- Préconditions : build/numéro exacts enregistrés ; installation propre puis
...
|---:|---|---|
| 1 | Installer la build sur iPhone et iPad puis lancer la Bibliothèque. | Installation, lancement et lecture réussissent sans dépendre de Swift Playgrounds. |
| 2 | Créer ou ouvrir un album et parcourir toutes les fonctions publiques du Lot 2. | Photos, textes, stickers, modèles, fonds, décors exclusifs et contours sont présents et correctement rendus. |
| 3 | Rejouer `IPAD-L2-082…083` puis le contrôle tactile de `077`. | Décors exclusifs, fenêtre texte et panneaux à fort zoom restent conformes dans la build distribuée. |
| 4 | Annuler/rétablir, sauvegarder, passer en arrière-plan, forcer la fermeture puis relancer hors ligne. | Données et ressources intégrées persistent ; aucun état combiné ou presse-papiers de session ne ressuscite. |
| 5 | Tester portrait, paysage, grande taille de texte et VoiceOver sur iPhone et iPad. | Aucun contrôle essentiel n’est inaccessible et les libellés/états restent compréhensibles. |
| 6 | Examiner journaux TestFlight et rapports de crash. | Aucun crash, blocage, corruption ni erreur répétée de catalogue n’est enregistré. |
