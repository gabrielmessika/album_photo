...
- Implémentation : après les échecs de compilation de `06c30b9…` et
  ...
  compile et contraint trois colonnes, mais `142` confirme que la largeur
  minimale de toute la ligne ajout/zoom/navigation repousse encore le rail et
  ...
  disponible depuis le panneau Photos et les cadres ; `IPAD-L2-013` réussit
  ...
  `8aa7f566de775c15ddf5a9e702a01ed5e9fdb640`, mais `IPAD-L2-015` échoue
  immédiatement : la fenêtre est devenue minuscule et illisible. La seconde
  correction fixe explicitement le cadre iPad à 400 × 340 points et conserve
  la présentation native en largeur compacte. Elle est figée dans
  `7d8772c6d87a769a239b4f9eafabe74c8c126681` et `IPAD-L2-016` reste à
  exécuter.
...
- Validation actuelle : 134 tests du noyau multiplateforme, les contrats et la
  ...
  134 tests et l’analyse syntaxique sous WSL, mais `IPAD-L2-015` est lui aussi
  🔴 `ÉCHOUÉ` sur `8aa7f56…`. La seconde correction passe sous WSL et reste ⚪
  `NON TESTÉ` sous `IPAD-L2-016` sur `7d8772c…`. Le menu Plus n’est attendu
  qu’en largeur compacte et sera repris
  ...
  `48e9fef9c317835f605df430c4112320d8cb66c3`, `141` est réussi indirectement
  et `142` échoue en portrait. Sur `101e2948252f51991933b8d61f767f52aa6b629d`,
  `143` et `144` sont ensuite réussis. Les qualifications iPhone, Xcode et
