...
final class ManifestContractTests: XCTestCase {
    ...
    func testPageWorkspaceUsesConfirmedAppendAndExplicitPageManagementLabel() throws {
        ...
        XCTAssertTrue(editor.contains(".frame(width: 400, height: 340)"))
        XCTAssertTrue(editor.contains(".presentationSizing(.fitted)"))
        XCTAssertTrue(editor.contains(".presentationSizing(.page)"))
