...
| Dépôt, registre du correctif Lot 2, 2026-08-17 | Comptage des IDs synthétiques/détaillés, champs obligatoires, hash candidat, traçabilité et format des étapes | **OK** : 12 IDs `IPAD-L2` synthétiques et 12 fiches détaillées ; les 9 fiches détaillées encore à ⚪ (`IPAD-L2-009…012`, `APPLE-L1-010…013`, `APPLE-L2-001`) présentent chaque étape dans un tableau `ID`/`Description`/`Résultat attendu` | Contrôle documentaire ; aucune preuve Apple extrapolée |
