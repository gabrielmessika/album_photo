...
/// Platform adapters convert an attributed paste to this allow-listed shape.
...
public enum TextEditingPrototype {
    ...
    /// URLs remain plain text; attachment placeholders and unmodeled control
    /// characters are removed. Only modeled Photoweb attributes reach runs.
